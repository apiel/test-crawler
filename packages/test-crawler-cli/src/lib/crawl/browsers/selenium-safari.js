...
function startSeleniumSafari(viewport, pngFile, htmlFile, crawler, projectId, id, url) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const driver = yield new selenium_webdriver_1.Builder().forBrowser('safari').build();
        driver
            .manage()
            .window()
...
function getScrollHeight(url, viewport) {
    return __awaiter(this, void 0, void 0, function* () {
        let driver = yield new selenium_webdriver_1.Builder().forBrowser('safari').build();
        driver
            .manage()
            .window()
...
//# sourceMappingURL=selenium-safari.js.map
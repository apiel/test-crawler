...
import { CrawlerProvider } from './lib/CrawlerProvider';
...
export function saveBeforeAfterCode(
    storageType: StorageType,
    projectId: string,
...
export function getBeforeAfterCode(
    storageType: StorageType,
    projectId: string,
    type: BeforeAfterType,
): Promise<string> {
...
export async function setZoneStatus(
    ...
    const crawlerProvider = new CrawlerProvider(storageType, this);
    return crawlerProvider.setZoneStatus(
        projectId,
        timestamp,
        id,
        status,
...
export async function setZonesStatus(
    storageType: StorageType,
    projectId: string,
    timestamp: string,
    id: string,

...
class CrawlerProvider extends CrawlerProviderBase_1.CrawlerProviderBase {
    ...
    loadProject(projectId) {
        return this.readJSON(projectId, this.join(projectId, `project.json`), CrawlerProviderBase_1.LOCAL);
    }
    loadProjects() {
        return __awaiter(this, void 0, void 0, function* () {
            const projects = yield this.readdir('', config_1.PROJECT_FOLDER, CrawlerProviderBase_1.LOCAL);
    ...
    getCrawler(projectId, timestamp) {
        ...
        return this.readJSON(projectId, path);
    }
    getAllCrawlers(projectId) {
        return __awaiter(this, void 0, void 0, function* () {
            const path = this.join(projectId, config_1.CRAWL_FOLDER);
            const folders = yield this.readdir(projectId, path);
    ...
    saveCode(projectId, code) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.saveJSON(projectId, this.join(projectId, config_1.CODE_FOLDER, `list.json`), Object.assign({}, list));
            yield this.saveFile(projectId, this.join(projectId, config_1.CODE_FOLDER, `${code.id}.js`), source);
        });
    }
    ...
    getPins(projectId) {
        return this.getPinsInFolder(projectId, this.join(projectId, config_1.PIN_FOLDER));
    }
    getPin(projectId, id) {
        return this.getPageInFolder(projectId, this.join(projectId, config_1.PIN_FOLDER), id);
    }
    getPages(projectId, timestamp) {
        return this.getPinsInFolder(projectId, this.join(projectId, config_1.CRAWL_FOLDER, timestamp));
    }

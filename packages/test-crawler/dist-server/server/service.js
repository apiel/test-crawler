...
const CrawlerProvider_1 = require("./lib/CrawlerProvider");
...
function getInfo(storageType) {
    const crawlerProvider = new CrawlerProvider_1.CrawlerProvider(storageType, this);
...
function startCrawlers() {
    const crawlerProvider = new CrawlerProvider_1.CrawlerProvider(undefined, this);
